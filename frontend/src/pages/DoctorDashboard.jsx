...
// Import the 3 separate style files
...
export default function DoctorDashboard() {
            ...
            <div style={s.modalBox} onClick={e => e.stopPropagation()}>
                ...
                <div style={s.modalBody}>
                    ...
                    <div style={pps.infoGridCentered}>
                        <div style={{textAlign: 'left'}}>
                            ...
                            <div style={s.infoValue}>{selectedScan?.name || selectedScan?.scanType}</div>
                        </div>
                        <div style={{textAlign: 'left'}}>
                            <div style={s.infoLabel}>Modality</div>
                            <div style={s.infoValue}>{selectedScan?.modality}</div>
                        </div>
                    </div>
                ...
                {!selectedScan?.isReadOnly && (
                    <div style={s.modalFooter}>
                        <button style={s.actionButton} onClick={() => setShowReportModal(false)}>Cancel</button>
                        <button style={{...s.actionButton, backgroundColor: '#02505F', color: 'white'}} onClick={handleSubmitReport}>Submit Report</button>
                    </div>
                )}
            </div>
        </div>
    ...
    const RenderMedicationModal = () => (
        <div style={s.modalOverlay} onClick={() => setShowMedicationModal(false)}>
            <div style={s.modalBox} onClick={e => e.stopPropagation()}>
                <div style={s.modalHeader}>
                ...
                <div style={s.modalFooter}>
                    <button style={s.actionButton} onClick={() => setShowMedicationModal(false)}>Cancel</button>
                    <button style={{...s.actionButton, backgroundColor: '#4361ee', color: 'white'}} onClick={() => setShowMedicationModal(false)}>Prescribe</button>
                </div>
            </div>
        </div>
    );
    ...
    const RenderScanOrderModal = () => (
        <div style={s.modalOverlay} onClick={() => setShowScanOrderModal(false)}>
            <div style={s.modalBox} onClick={e => e.stopPropagation()}>
                <div style={s.modalHeader}>
                ...
                <div style={s.modalFooter}>
                    <button style={s.actionButton} onClick={() => setShowScanOrderModal(false)}>Cancel</button>
                    <button style={{...s.actionButton, backgroundColor: '#02505F', color: 'white'}} onClick={() => setShowScanOrderModal(false)}>Order Scan</button>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div style={s.container}>
            ...
            <div style={s.mainWrapper}>
                ...
                {/* ROUTING LOGIC */}
                {selectedPatient ? <ProfileView /> : 
                 activeTab === 'patients' ? <PatientsListView /> :
                 activeTab === 'profile-settings' ? <ProfileSettingsView /> :
                 <DashboardView />}
            </div>
